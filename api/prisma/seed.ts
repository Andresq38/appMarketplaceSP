...
async function main() { 
    ...
    await prisma.cita.createMany({
        data: [
            ...
            {
                clienteId: userMap["mayaquesada@gmail.com"],
                perfilProfesionalId: perfilValeria.id,
                servicioId: servicios[9].id,
                fechaSolicitada: ahora,
                fechaCita: new Date(ahora.getTime() + 5 * 24 * 60 * 60 * 1000),
                horaInicio: "11:00",
                horaFin: "12:00",
                modalidad: "VIRTUAL",
                estado: EstadoCita.ACEPTADA,
                descripcion: "Revisión de medicamentos prescritos",
                monto: 85000,
            },
            {
                clienteId: userMap["liaquesada@gmail.com"],
                ...
                fechaSolicitada: ahora,
                fechaCita: new Date(ahora.getTime() + 4 * 24 * 60 * 60 * 1000),
                horaInicio: "15:00",
                horaFin: "16:30",
                modalidad: "PRESENCIAL",
                estado: EstadoCita.PENDIENTE,
                descripcion: "Revisión de salud integral anual",
                monto: 150000,
            },
            {
                clienteId: userMap["cecialiamolina@gmail.com"],
                ...
                fechaSolicitada: pasado,
                fechaCita: new Date(pasado.getTime() + 3 * 24 * 60 * 60 * 1000),
                horaInicio: "16:00",
                horaFin: "17:30",
                modalidad: "PRESENCIAL",
            ...
            },
            {
                clienteId: userMap["mayaquesada@gmail.com"],
                perfilProfesionalId: perfilSamantha.id,
                servicioId: servicios[5].id,
                fechaSolicitada: pasado,
                fechaCita: new Date(pasado.getTime() + 1 * 24 * 60 * 60 * 1000),
                horaInicio: "10:00",
                horaFin: "11:30",
                modalidad: "VIRTUAL",
                estado: EstadoCita.COMPLETADA,
            ...
            },
            {
                clienteId: userMap["cecialiamolina@gmail.com"],
                perfilProfesionalId: perfilValeria.id,
                servicioId: servicios[8].id,
                fechaSolicitada: ahora,
                fechaCita: new Date(ahora.getTime() + 6 * 24 * 60 * 60 * 1000),
                horaInicio: "14:00",
                horaFin: "14:45",
                modalidad: "VIRTUAL",
                estado: EstadoCita.PENDIENTE,
                descripcion: "Consulta sobre medicamentos actuales",
                monto: 70000,
            },
            {
                clienteId: userMap["mayaquesada@gmail.com"],
                ...
                servicioId: servicios[1].id,
                fechaSolicitada: ahora,
                fechaCita: new Date(ahora.getTime() + 8 * 24 * 60 * 60 * 1000),
                horaInicio: "11:00",
                horaFin: "12:30",
                modalidad: "PRESENCIAL",
                estado: EstadoCita.PENDIENTE,
                descripcion: "Chequeo anual de salud",
                monto: 150000,
            },
            {
                clienteId: userMap["liaquesada@gmail.com"],
                ...
                servicioId: servicios[3].id,
                fechaSolicitada: ahora,
                fechaCita: new Date(ahora.getTime() + 7 * 24 * 60 * 60 * 1000),
                horaInicio: "13:00",
                horaFin: "14:30",
                modalidad: "PRESENCIAL",
                estado: EstadoCita.PENDIENTE,
                descripcion: "Blanqueamiento dental para evento especial",
                monto: 120000,
            },
            {
                clienteId: userMap["cecialiamolina@gmail.com"],
                ...
                servicioId: servicios[4].id,
                fechaSolicitada: ahora,
                fechaCita: new Date(ahora.getTime() + 9 * 24 * 60 * 60 * 1000),
                horaInicio: "16:00",
                horaFin: "17:00",
                modalidad: "VIRTUAL",
                estado: EstadoCita.PENDIENTE,
